...
1.  Install the `cx` command-line shell (v0.5.0).
...
Download and install the latest `v0.5.0` pre-compiled binary for your operating system from our [**GitHub Releases page**](https://github.com/flowcontextually/cx-shell/releases).

=== "Linux"

    ```bash
    # This script downloads the latest v0.5.0 Linux binary and moves it to your path.
...
=== "macOS (Intel & Apple Silicon)"
    ...
    ```bash
    # This script downloads the latest v0.5.0 macOS binary and moves it to your path.
...
=== "Windows (PowerShell)"
    ...
    ```powershell
    # This script downloads the latest v0.5.0 Windows binary and unzips it.
